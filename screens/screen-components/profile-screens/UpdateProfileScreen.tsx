...
function UpdateProfileScreen() {
  ...
  return (
    ...
    <View style={tw`flex-row mt-10`}>
      ...
      <View style={tw`px-2`}>
        <TextInput style={tw`border px-2 py-1  text-gray-400 rounded-lg w-48`} defaultValue={profile.favoriteAnimeId} ></TextInput>
        <TextInput style={tw`mt-4  border px-2 py-1  text-gray-400 rounded-lg`} defaultValue={profile.favoriteAnimeId}></TextInput>
        <TextInput style={tw`mt-4 border px-2 py-1 text-gray-400 rounded-lg`} defaultValue={profile.favoriteCharacterId}></TextInput>
        <TextInput style={tw`mt-4 border px-2 py-1 text-gray-400 rounded-lg`} defaultValue={profile.zipcode}></TextInput>
      </View>
    </View>

    <View style={tw`flex-row px-5 mt-6 mr-4 `}>
      <Text style={tw`font-bold`}>Bio &nbsp;&nbsp;</Text>
      <TextInput style={tw` px-2 py-2 border text-gray-400 rounded-lg ml-2`} multiline={true} numberOfLines={4} defaultValue={profile.bio}></TextInput>
    </View>
